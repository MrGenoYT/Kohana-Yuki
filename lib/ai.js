...
async function handleMessage(message, client) {
    ...
    // Acknowledge the message immediately by sending a typing indicator
...
Remember: You decided to respond to this message because you felt it was worth responding to. Be natural and engaging. Sometimes refer to the user personally (e.g., "Hi ${userName}~" or "You know, ${userName}, ..."). Use varied humanlike expressions.`;

    try {
        // Filter chat history to only include 'role' and 'parts' for the API
        ...
        const chat = model.startChat({
            history: filteredChatHistory, // Use the filtered history
            generationConfig: {
                maxOutputTokens: 1000,
                temperature: 0.9,
            },
