...
async function getUserData(userId, db) {
    ...
    if (!userData) {
        userData = {
            ...
            name: null, // Initialize name as null, will be set from Discord username on first message
            gender: null, // Initialize gender as null, user can set via persona modal
        };
